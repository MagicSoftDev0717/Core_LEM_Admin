        ...
        <div className="AppLayoutWrapper">
            ...
            <div className="top-header-cont">
              <div className="left-container">
                <div className="product-suite-block">
                  Product Suite
                  <img src="/assets/image/header-arrow-right.svg" alt="Product suite arrow right" fetchPriority="high" width="16" height="21" decoding="async" data-nimg="1" className="top-header-img arrow-right" style={{ color: 'transparent' }} />
                </div>
                ...
                <a title="LearnEnglishMaths" className="hiree365-logo" href="https://www.hiree365.com/" target="_blank">
                <img alt="logo" loading="lazy" width="60" height="16" decoding="async" data-nimg="1" className="top-header-img" style={{ color: 'transparent' }} src="/assets/images/hiree365-logo.svg" /></a>
              </div>
          ...
          <div className="HeaderView">
            <div className="HeaderWrapper">
              <div className="HeaderNavWrapper">
                <div className="AppLogoWrapper">
                  <img src="/assets/image/core-lem-logo.svg" alt="Product suite arrow right" fetchPriority="high" decoding="async" data-nimg="1" className="top-header-img arrow-right" style={{ color: 'transparent' }} />
                </div>
            ...
            <div className="MobileHeaderNavWrapper">
              <button className="ButtonWrapper sm"><span>Try it Free</span><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path></svg></button>
              <div className="MenuButton"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M32 96v64h448V96H32zm0 128v64h448v-64H32zm0 128v64h448v-64H32z"></path></svg>
              </div>
            </div>
            <div className=" MobileNavbarContainer">
              <div className="CloseButton"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M289.94 256l95-95A24 24 0 00351 127l-95 95-95-95a24 24 0 00-34 34l95 95-95 95a24 24 0 1034 34l95-95 95 95a24 24 0 0034-34z"></path></svg>
              </div>
          ...
          <div className="AppContentWrapper">
            <div className="LandingSectionWrapper">
              ...
              <img alt="Schedules &amp; communication" loading="lazy" width="48" height="48" decoding="async" data-nimg="1" className="shape-2" style={{ color: 'transparent' }} src="/assets/images/shapes/Schedules &amp; communication.webp"></img>
                      ...
                      <div className="swiper swiper-initialized swiper-horizontal mySwiper swiper-backface-hidden">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide swiper-slide-active" style={{ width: '215.667px', marginRight: '30px' }} data-swiper-slide-index="0">
                            <div><img src="/assets/images/trusted/1.webp" alt="Asian Institute of Management" title="Asian Institute of Management" fetchPriority="high" width="68" height="49" decoding="async" data-nimg="1" style={{ color: 'transparent' }} /></div>
                          </div>
