        ...
        <div>
            <div className=" p-4 rounded-3xl w-full">
                <div className="grid grid-cols-6 gap-x-1 gap-y-1 mt-6">
                    <Button size="sm" variant="outline">Start Enrollment Opportunity</Button>
                    <Button size="sm" variant="outline">Holds</Button>
                    <Button size="sm" variant="outline">Inactivate Enrollments</Button>
                </div>
            </div>
