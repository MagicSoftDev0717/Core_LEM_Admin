                        ...
                        <div className="space-y-3">
                            <div className="overflow-hidden rounded-xl bg-brand-50">
                                <div className="flex cursor-pointer items-center justify-between px-6 py-4 bg-brand-50 dark:bg-brand-100">
                                    <h4 className="text-lg font-medium text-gray-800">Delivery Method Status definitions:</h4>
                                ...
                                <div className="p-6 border-t border-brand-100 dark:border-brand-200">
                                    <p className="text-base text-gray-800">Changing to In-center – During the specified date range, the Delivery Method will change to In-center. Applies after today’s date.
                                        Changing to @home – During the specified date range, the Delivery Method will change to @home. Applies after today’s date.
                                    </p>
                                </div>
                            </div>
                        </div>
